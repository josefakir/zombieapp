...
function warningAlert(a, b) {
  "undefined" == typeof b && ((b = a), (a = "Warning")),
    showAlert(a, b, "yellow");
}
...
function imageAlert(a, b) {
  "auto" == typeof b && (iframeHeight = !1),
    $.jAlert({ image: a, imageWidth: b });
}
